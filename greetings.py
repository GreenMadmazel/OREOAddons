...
from pyOreo.dB.greetings_db import (
    add_goodbye,
    add_thanks,
    add_welcome,
    delete_goodbye,
...
from pyOreo.fns.tools import create_tl_btn, format_btn, get_msg_button

from . import HNDLR, eor, get_string, mediainfo, oreo_cmd
from ._inline import something

Note = "\n\nNote: `{mention}`, `{group}`, `{count}`, `{name}`, `{fullname}`, `{username}`, `{userid}` can be used as formatting parameters.\n\n"


@oreo_cmd(pattern="setwelcome", groups_only=True)
...
@oreo_cmd(pattern="clearwelcome$", groups_only=True)
...
@oreo_cmd(pattern="getwelcome$", groups_only=True)
...
@oreo_cmd(pattern="setgoodbye", groups_only=True)
...
@oreo_cmd(pattern="cleargoodbye$", groups_only=True)
...
@oreo_cmd(pattern="getgoodbye$", groups_only=True)
...
@oreo_cmd(pattern="thankmembers (on|off)", groups_only=True)
